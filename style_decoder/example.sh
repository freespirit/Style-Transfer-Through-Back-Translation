...
python translate.py -gpu 0 -model ../models/translation/english_french/english_french.pt -src ../data/political_data/democratic_only.train.en -output ../data/political_data/democratic_only.train.fr -replace_unk $true
python translate.py -gpu 0 -model ../models/translation/english_french/english_french.pt -src ../data/political_data/democratic_only.dev.en -output ../data/political_data/democratic_only.dev.fr -replace_unk $true

python translate.py -gpu 0 -model ../models/translation/english_french/english_french.pt -src ../data/political_data/republican_only.test.en -output ../data/political_data/republican_only.test.fr -replace_unk $true
python translate.py -gpu 0 -model ../models/translation/english_french/english_french.pt -src ../data/political_data/democratic_only.test.en -output ../data/political_data/democratic_only.test.fr -replace_unk $true
